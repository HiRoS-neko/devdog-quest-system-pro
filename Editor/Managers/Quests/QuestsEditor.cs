...
namespace Devdog.QuestSystemPro.Editors
{
    public class QuestsEditor : EditorCrudBase<Quest>
    {
        ...
        {
            get => new(QuestManager.instance.quests);
            set
            {
        ...
        protected override void CreateNewItem()
        {
            ...
            {
                var asset = (Quest)ScriptableObjectUtility.CreateAsset(type,
                    EditorPrefs.GetString(SettingsEditor.PrefabSaveKey), GetAssetName());
        ...
        protected override void DrawDetail(Quest item, int index)
        {
            ...
            if (_previouslySelectedGUIItemName == "Quest_Name" &&
