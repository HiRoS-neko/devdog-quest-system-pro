...
namespace Devdog.QuestSystemPro.Editors
{
    ...
    public class SpawnerBaseEditor : Editor
    {
        ...
        protected void OnEnable()
        {
            ...
            foreach (Transform child in t.transform) DestroyImmediate(child.gameObject);

            _relevancyList = new ModuleList<IObjectRelevancy>(t, this, "Object relevacny");
            _relevancyList.description =
                "Object relevancy can be used to detect if the spawner should spawn it's objects or destroy them.";
            ...
            TryInit(t);
            TryInit(t.GetComponent<IObjectRelevancy>() as Object);
            TryInit(t.GetComponent<ISpawnerVolume>() as Object);
        }

        private void TryInit(Object t)
        {
            if (t != null)
            {
                var awake = t.GetType().GetMethod("Awake",
                    BindingFlags.Public | BindingFlags.NonPublic | BindingFlags.Instance);
                if (awake != null) awake.Invoke(t, null);
            }
        }
        ...
        public override void OnInspectorGUI()
        {
            ...
            {
                if (GUILayout.Button("Delete preview items")) t.DestroyAllSpawnedObjects();
            }
            else
            {
