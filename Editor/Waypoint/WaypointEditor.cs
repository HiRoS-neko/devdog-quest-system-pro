...
namespace Devdog.QuestSystemPro.Editors
{
    ...
    public class WaypointEditor : Editor
    {
        ...
        public void OnEnable()
        {
            ...
            _waypointActions.description =
                "Waypoint actions can be used to let a character perform an action at this waypoing\nThese actions can be async.";

            _waypointConditions = new ModuleList<IWaypointCondition>(t, this, "Waypoint conditions");
            _waypointConditions.description =
                "Waypoint conditions can be used to prevent a character from moving to the next waypoint.";
        }
